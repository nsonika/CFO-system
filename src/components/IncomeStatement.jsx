                ...
                <tbody>
                    ...
                    <tr className="font-semibold border-b">
                        ...
                        >
                            $
                            {(
                                financialData.revenue[2024] -
                                Object.values(financialData.expenses[2024]).reduce((a, b) => a + b, 0)
                            ).toLocaleString()}
                        </td>
                        <td
                            className={`py-2 text-right ${financialData.revenue[2023] - Object.values(financialData.expenses[2023]).reduce((a, b) => a + b, 0) >= 0
                                ? "text-green-600"
                                : "text-red-600"
                                }`}
                        >
